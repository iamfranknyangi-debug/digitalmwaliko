...
import { Sparkles, Send, QrCode, BarChart3, Users, CreditCard, ArrowRight, CheckCircle2, Loader2, Check, Crown, Star, Zap } from 'lucide-react';
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            >
              ...
              <ul className="space-y-3 mb-8">
                {['Up to 150 SMS invitations', 'Basic card templates', 'QR code verification', 'RSVP tracking', 'Email support'].map((f) => (
